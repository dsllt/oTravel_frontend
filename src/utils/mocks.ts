...
},
{
    ...
    "description": "Localizado no coração do Porto, este café destaca-se pela combinação perfeita entre sabor e hospitalidade. Com uma seleção de cafés excepcionais, acompanhados da tradicional nata, o estabelecimento oferece uma experiência gastronômica que agrada aos paladares mais exigentes. O ambiente é lindo e super acolhedor, proporcionando um espaço convidativo para relaxar e desfrutar de boas conversas.\n\nO atendimento é uma das marcas registradas do café. Os funcionários são extremamente simpáticos e profundos conhecedores do assunto, garantindo um serviço atencioso e personalizado. Não é surpresa que muitos clientes fiéis considerem este café um dos melhores da cidade, um lugar que sempre vale a pena revisitar.",
