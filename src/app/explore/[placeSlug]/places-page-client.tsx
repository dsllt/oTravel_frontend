          ...
          <div className="flex w-full h-full justify-center items-start gap-16">
            ...
            <div className="flex flex-col gap-4 font-dmSans min-w-[500px]">
              ...
              <div className="">
                ...
                <ScheduleEditModal placeSchedule={placeSchedule} setPlaceSchedule={setPlaceSchedule} />
                      ...
                      <table className="table">
                        <tbody>
                          {placeSchedule.slice(0, 4).map((day) => {
                            return (
                              <tr className="hover:bg-base-100 flex justify-between" key={day.week_day}>
                                <td className="rounded-l-md py-2 px-1 whitespace-nowrap">{day.week_day}</td>
                                <td className="rounded-r-md py-2 px-1 whitespace-nowrap ">{day.open_time} - {day.close_time}</td>
                              </tr>
                            )
                          })}
                        </tbody>
                        ...
                        <tbody>
                          {placeSchedule.slice(4, 7).map((day) => {
                            return (
                              <tr className="hover:bg-base-100 flex justify-between" key={day.week_day}>
                                <td className="rounded-l-md py-2 px-1 whitespace-nowrap">{day.week_day}</td>
                                <td className="rounded-l-md py-2 px-1 whitespace-nowrap">{day.open_time} - {day.close_time}</td>
                              </tr>
                            )
                          })}
                        </tbody>
